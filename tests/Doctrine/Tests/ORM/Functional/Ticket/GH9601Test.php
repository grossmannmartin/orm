...
class GH9601Test extends OrmFunctionalTestCase
{
    ...
    public function testBasicNativeQuery(): void
    {
        ...
        $rsm->addRootEntityFromClassMetadata(GH9601User::class, 'u');
        $rsm->addJoinedEntityFromClassMetadata(GH9601Address::class, 'a', 'u', 'address');
...
class GH9601Address
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="GH9601User", mappedBy="address")
     */
    public $user;
}
...
class GH9601User
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="GH9601Address", inversedBy="user")
